...
fn test_compact {
    ...
    // 65
    assert_encode(Compact(0b01000000u8), &[0b00000101,0b00000001]);
    assert_encode(Compact(0b01000000u64), &[0b00000101,0b00000001]);
    assert_encode(Compact(0b01000000u128), &[0b00000101,0b00000001]);
    
    // 16383
    assert_encode(Compact((1u64 << 14)-1), &[0b111101,0b11111111]);
    assert_encode(Compact((1u128 << 14)-1), &[0b111101,0b11111111]);
